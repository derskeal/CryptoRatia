...
public class eth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText ethet = (EditText) findViewById(R.id.ethinputtext);
        ethet.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
    ...
    public void workFunction(double un){
        String[] myDataset = {"BTC","NGN", "USD", "KWD", "BHD", "OMR", "GBP", "EUR", "CHF","CAD","AUD","BND","SGD","PLN",
                "NZD","BGN","BRL","ILS","RON","TRL","NOK","QAR","SAR"};

        String[] myDatasetValue = new String[23];

        Intent myethintent = getIntent();
        String myresult = myethintent.getStringExtra("jsonresult");
        ...
        mySLR = (SwipeRefreshLayout) findViewById(R.id.myswiperefresheth);
    ...
    public void convert(View view) {
        ...
        EditText btcet = (EditText)findViewById(R.id.ethinputtext);
